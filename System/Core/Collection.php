...
class Collection implements \ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable {
    ...
    /**
     * Exchanges the current items with the input.
     *
     * @param array $array The values to exchange with
     * @param array $items
     *
     * @return array The old items
     */
    public function exchange(array $items) {
        $old = $this->all();
        $this->clear();
        $this->replace($items);
    ...
    /**
     * Return a array for jsonSerialize.
     *
     * @return array
     */
